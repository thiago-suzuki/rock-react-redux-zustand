...
//     it('shouild be able to play next video automatically', () => {
...
//     it('shouild be able to jump to the next module automatically', () => {
//         const state = reducer({
//             ...exampleState,
...
//     it('shouild not update the current module and lesson index if there is no next lesson available', () => {
//         const state = reducer({
//             ...exampleState,
